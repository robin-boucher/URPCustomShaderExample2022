Shader "Sample/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Inc/Sample-LitForwardPass.hlsl"
        ...
        Pass
        {
            ...
            // Custom LitForward pass
            #include "Inc/Sample-LitGBufferPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/SurfaceInput.hlsl"
            // Required for rendering layers for decals
        ...
        Pass
        {
            ...
            #include "Inc/Sample-LitMetaPass.hlsl"
